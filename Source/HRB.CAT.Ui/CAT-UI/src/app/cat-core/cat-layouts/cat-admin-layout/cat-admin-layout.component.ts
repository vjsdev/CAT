...
@Component({
  selector: 'cat-admin-layout',
  templateUrl: './cat-admin-layout.component.html',
  styleUrls: ['./cat-admin-layout.component.css']
})
export class CatAdminLayoutComponent implements OnInit {
